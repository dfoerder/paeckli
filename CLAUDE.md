...
Meilensteinen. `minor` läuft dabei über 9 hinaus weiter (v2.9b → **v2.10b**),
ein Feature-Deployment löst also nie von sich aus einen `major`-Sprung aus.
Kein Build-Step, daher von Hand gepflegt: **vor jedem
